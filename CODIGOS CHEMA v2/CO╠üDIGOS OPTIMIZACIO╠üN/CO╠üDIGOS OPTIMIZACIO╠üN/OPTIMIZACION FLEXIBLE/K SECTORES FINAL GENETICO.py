...
ax.set_title("Sectorización con Complejidad Total")
...
def optimize_pairs(original_assignment, df_cells, G, max_change=40):
...
for i in range(1, num_runs + 1):
    ...
    assignment = optimize_pairs(assignment, df_cells, G, max_change=40)
